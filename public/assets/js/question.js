...
function addOptions(){
  ...
  $("#add-question").on("click", function(){
    var val = $(".question-no").last().text();
    var newval = Number(val)+1;
    // var othval = $(".option-input").last().get(0).id;
    // var id = Number(othval)+1;
    // console.log(val);
    $(".question-pannel").append('<li class="question-no"><span>'+newval+'</span></li>');
    $(".question-container").append('<div class="modal-body" id="q-'+newval+'"></div>');
  });
}
